...
import cn.shuyouliu.gen.entity.GenCategory;
...
import cn.shuyouliu.gen.entity.StringUtils;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme,GenTable gentable){
		...
		model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor():"getName");//UserUtils.getUser().getName()
		model.put("functionVersion", "2016-07-08");//DateUtils.getDate()
		...
		model.put("dbType", "mysql" );//Global.getConfig("jdbc.type")
